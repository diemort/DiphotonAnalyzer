#ifndef DiphotonAnalyzer_TreeProducer_gggg_TreeEvent_h
#define DiphotonAnalyzer_TreeProducer_gggg_TreeEvent_h
...
namespace gggg
{
  struct TreeEvent
  {
    ...
    void attach( TTree* tree, bool data = false, const std::vector<std::string>& list = {} ) {
      if ( !tree ) return;
