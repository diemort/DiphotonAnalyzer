...
#pileupCalc.py -i ${JSON_FILE} --inputLumiJSON ${PILEUP_FILE} --calcMode true --minBiasXsec 69200 --maxPileupBin 99 --numPileupBins 99 pileup_data16BCG_PPSruns_99bins.root
